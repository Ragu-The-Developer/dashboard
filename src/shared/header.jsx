  ...
  return (
    ...
    <Menu as="div" className="relative">
      <div>
        ...
        >
          <Menu.Items className="origin-top-right z-10 absolute right-0 mt-2 w-48 rounded-sm shadow-md p-1 bg-white
               ring-1 ring-black ring-opacity-5 focus: outline-none">
              <Menu.Item>
                {({ active }) => (
                   <div className={classNames(active && 'bg-gray-50','text-gray-700 bg-gray-200 cursor-pointer rounded-sm px-4 py-2')}
